...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    'getting-started',
    {
      ...
      label: 'Guide',
      collapsed: false,
      items: ['guide/deploy', 'guide/service', 'guide/backups', 'guide/bootstrap', 'guide/pillar', 'guide/config', 'guide/orchestrator', 'guide/analytics', 'guide/upgrading', 'guide/menu'],
    },
    {
      type: 'category',
      label: 'Alerts',
